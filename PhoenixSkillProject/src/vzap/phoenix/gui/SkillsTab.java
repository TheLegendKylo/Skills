...
//		Getting ready to delete and delete skills
		...
		//scrollPaneBottom.remove(detailedTable);
		//detailTableModel.setRowCount(0);
		System.out.println("info retruned : " + clientControl.getEmpCapabilityDetail(selectedEmpSkill).getRowCount());
		//detailTableModel = clientControl.getEmpCapabilityDetail(selectedEmpSkill);
		detailedTable.setModel(clientControl.getEmpCapabilityDetail(selectedEmpSkill));
		detailedTable.updateUI();
//		JTable detailTable  = new JTable(detailTableModel);
//		scrollPaneBottom.add(detailTable);
//		scrollPaneBottom.setViewportView(detailedTable);;
